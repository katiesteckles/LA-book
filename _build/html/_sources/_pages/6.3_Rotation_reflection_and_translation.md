...
We can find an expression for the coordinates of $\mathbb{u}$ and $\vmathbb{v}$ in terms of $\|\mathbf{u}\|$ and $\phi$. Consider the right-angled triangle (shown in \textcolor{blue}{blue}) with the angle $\phi$ and hypotenuse of length $\|\mathbf{u}\|$. Then
