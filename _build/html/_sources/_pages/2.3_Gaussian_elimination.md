...
$$ \begin{align*}
    &\begin{pmatrix}{ccc|c} \color{red}{1} & 2 \\ 0 & \color{red}{3} \end{pmatrix} &
...
We say that a system of linear equations is in row echelon form if the corresponding augmented matrix is in row echelon form.
---
...
The element in row 3 column 2 has a value of $\displaystyle-\dfrac{11}{3}$ and the pivot element has a value of $\displaystyle-\dfrac{4}{3}$, so we need to subtract row 2 multiplied by $\displaystyle-\dfrac{11}{3} \div \left(-\dfrac{4}{3}\right) = \dfrac{11}{4}$ from row 3.
