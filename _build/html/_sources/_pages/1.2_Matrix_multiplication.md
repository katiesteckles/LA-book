...
$$ 2 \times \textcolor{red}{2} with \textcolor{red}{2} \times 2 \qquad 4 \times \textcolor{red}{3} with \textcolor{red}{3} \times 2 \qquad 3 \times \textcolor{red}{3} with \textcolor{red}{3} \times 5 $$

These pairs cannot:

$$ 2 \times \textcolor{red}{2} with \textcolor{blue}{4} \times 3 \qquad 4 \times \textcolor{red}{5} with \textcolor{blue}{3} \times 1 \qquad 1 \times \textcolor{red}{3} with \textcolor{blue}{2} \times 2 $$
...
\qquad
    ...
    \underset{\textcolor{red}{2} \times 4}{\begin{pmatrix} g & h \\ i & k \\ k & l \\ m & n \end{pmatrix}}
\end{align*} $$
...
Using the rule given in equation {eq}`matrix-multiplication-equation`, to calculate $[AB]_{11}$ (the $(1,1)$th entry in the product) we use row $i=1$ and column $j=1$. We move through the elements from row 1 of $A$ and column 1 of $B$, multiplying the corresponding values and summing the result:
