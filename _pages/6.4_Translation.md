...
$$\underbrace{(x, y, 1)}_{\textsf{homogeneous}} \mapsto \underbrace{(x, y)}_{\textsf{Cartesian}}$$
...
An isosceles triangle has vertices with co-ordinates $(-1,-1)$, $(1,-1)$ and $(0,2)$. The triangle is transformed using the following transformations:
