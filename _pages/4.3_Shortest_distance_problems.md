...
Find the shortest distance between the point $\mathbf{P} = (4, -4, 3)$ and the plane $2x−2y+5z+8=0$.


```{dropdown} Solution

First, find the point-normal form of the plane. The normal vector is given by the coefficients of $x,y$ and $z$ in the equation, so it will be $\mathbf{n} = (2, -2, 5)$, and to normalise it to unit length we divide by its magnitude:

$$ |\mathbf{n}| = \sqrt{2^2 + (-2)^2 + 5^2} = \sqrt{4 + 4 + 25} = \sqrt{33} $$

$$\hat{\mathbf{n}} = (\frac{2}{\sqrt{33}}, \frac{-2}{\sqrt{33}}, \frac{5}{\sqrt{33}})$$

A point in the plane will satisfy the equation $2x-2y+5z+8=0$, and a point of this form can be found by setting $x=0$ and $y=0$, at which point $5z = -8$, so $z = -\frac{8}{5}$; so, the point $\mathbf{P}_0 = (0, 0, -\frac{8}{5})$ lies in the plane.
...
\begin{align*}& (4, -4,3) - (0, 0, -\frac{8}{5}) \cdot (\frac{2}{\sqrt{33}}, \frac{-2}{\sqrt{33}}, \frac{5}{\sqrt{33}})\\
